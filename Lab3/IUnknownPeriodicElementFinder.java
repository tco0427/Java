...
public class IUnknownPeriodicElementFinder implements IPeriodicElementFinder {
    ...
    public boolean isInstanceOf(PeriodicElement e){
        //매개변수 PeriodicElement형 e로 참조하는 인자로 전달된 인스턴스가 UnknownPeriodicElement인스턴스 이거나 UnknownPeriodicElement를 상속하는 인스턴스이면 true를, 아니면 false를 반환한다.
        if(e instanceof UnknownPeriodicElement)
            return true;
        else
            return false;
    }
